...
// Topic: Assignment 2 - Express Authentication
...
module.exports.displayBusPage = (req, res, next) => {
    Contact.find((err, contactList) => {
        if (err) {
            ...
            res.render('crud/busContact', { title: "Contact List", ContactList: contactList, displayName: req.user ? req.user.displayName : '' });
                ...
                */
                ...
                Contact.find((err, contactList) => {
                    if (err) {
                        ...
                        //  console.log(contactList);
                        return res.render('crud/busContact', { title: "Contact List", ContactList: contactList, displayName: req.user ? req.user.displayName : '' });
